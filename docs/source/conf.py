...
# See: http://stackoverflow.com/questions/12772927/specifying-an-online-image-in-sphinx-restructuredtext-format/28778969#28778969
#
# Sphinx consider external images as a warning. Since we do want warning as
# errors, bagdes fail to build. This disable warning on nonlocal images.
